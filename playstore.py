...
class Playstore(object):
    ...
    def app_details(self, package_name: str) -> object:
        ...
        #print(details.docV2.details.appDetails.versionCode)
        return details
    ...
    def download(self, package_name: str, file_name: str = None) -> bool:
        ...
        if details is None:
            ...
            return False
        if len(details.docV2.offer)<1: 
            logging.error('Can\'t proceed with the download. can't get details.docV2.offer[0])
            return False
